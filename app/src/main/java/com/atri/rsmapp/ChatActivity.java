...
import com.atri.rsmapp.Chat.MediaAdapter;
import com.atri.rsmapp.Chat.MessageAdapter;
import com.atri.rsmapp.Chat.MessageObject;
...
public class ChatActivity extends AppCompatActivity {
        ...
        mChatMessagesDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if(dataSnapshot.exists()){
                    ...
                    updateChatCanvasWithMessageObject(mMessage);
    ...
    private void updateChatCanvasWithMessageObject(final MessageObject messageObj) {
        String senderId = messageObj.getSenderId();
        UserObject senderUser = new UserObject(senderId);
        DatabaseReference mUserDB = FirebaseDatabase.getInstance().getReference().child("user").child(senderId);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    String phone = "",
                        ...
                        messageObj.setSenderName(mUser.getName());
